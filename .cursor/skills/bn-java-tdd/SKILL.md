---
name: bn-java-tdd
description: Подход TDD и правила написания Java-тестов (JUnit 5, Mockito, Spring Boot Test). Применять при написании, изменении или рефакторинге тестов, при красно-зелёно-рефактор цикле, при упоминании TDD, unit/integration/e2e тестов или /bn-java-tdd.
---
